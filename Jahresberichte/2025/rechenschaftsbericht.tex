...
Der Verein hatte zu Beginn des Geschäftsjahres 69 und zu dessen Ende 77 Mitglieder.
...
Mitglieder selbst steht weiterhin aus, da die dafür notwendige Satzungsänderung noch nicht final im
Vereinsregister eingetragen ist.

\section{Vorstand}

Dieser Rechenschaftsbericht wird vom Vorstand des Geschäftsjahres 2025 vorgelegt, der sich aus folgenden Personen zusammensetzt:
...
\begin{itemize}
 \item[] \textbf{1. Quartal}
   \begin{itemize}
     ...
     \item Vom 25.\ bis 27.~Februar findet am Karlsruher Institut für Technologie die deRSE25-Konferenz
       statt, gemeinsam mit der Fachtagung Software Engineering (SE25) der GI statt, mit mehr als 300 Teilnehmenden und 167 Beiträgen.
 ...
 \item[] \textbf{2. Quartal}
   \begin{itemize}
    \item Mit dem Projektstart von FutuRSI im April tritt der Verein erstmals als Arbeitgeber auf.
      ...
      finanziert.
    \item Der Vorstand beschließt die Steuerkanzlei S\&K mit der Erstellung der Steuererklärungen für
      die Jahre 2025 bis 2027 zu beauftragen, ein Beauftragung kommt jedoch nicht zustande. Die
      Steuererklärungen für die Jahre 2020 bis 2022 wurden zuvor abgeschlossen.
 ...
 \item[] \textbf{3. Quartal}
   \begin{itemize}
    \item Im Projekt FutuRSI werden die inhaltlichen Arbeiten fortgeführt: Die Erfassung der
      RSE-Gruppen in Deutschland beginnt, ein Leitfragenkatalog für Stakeholder-Interviews wird
      erstellt und die Interviews werden geführt, ein Kommunikationsplan wird entwickelt. Weitere
      Projektmitarbeitende bei den Partnern nehmen ihre Arbeit auf.
    \item Die \href{https://de-rse.org/blog/2025/09/22/deRSE26-call-for-contribution.html}{deRSE26}
      wird angekündigt: Call for Contributions und ein geplanter Post-Proceedings-Band. Die Konferenz
      findet vom 3.\ bis 5.~März 2026 an der Universität Stuttgart statt.
    \item Vom 15.\ bis 16.~September findet das Fachgruppentreffen RSE der GI in Potsdam statt, im
      ...
      ist.
    \item Die finale und überarbeitete Version des Papiers
...
\clearpage
 \item[] \textbf{4. Quartal}
   \begin{itemize}
    ...
    \item Das Positionspapier "`Establishing RSE departments in German research institutions"' wird bei
      F1000Research eingereicht und befindet sich in der öffentlichen Begutachtung.
    ...
    \item Am 20.~November richtet der Vorstand den Arbeitskreis "`RSE @ CoARA"' mit Alexander Struck
      ...
      damit beginnt eine unverbindliche Laufzeit von einem Jahr, innerhalb derer ein Action Plan
